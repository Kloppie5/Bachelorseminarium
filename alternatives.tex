...
The use of GPUs in Machine Learning is already a very common method. This is due to the nature of the data which makes up Machine Learning problems. A GPU is extremly fast at making multiple small calculations on a batch of data. Luckily the data that is requiered by Machine Learning algorithms such as Neural Networks and Unsupervised Learning is of this type. This means that GPUs have had a lot of success with speeding up these calcultions as was found by Meuth \ref{Meut2007} who reported a up to 200x speed up over conventional CPUs.

On top of the speedup that is currently available of CPUs over GPUs, while CPUs double in processing power every 2 years, accroding to Moore's law, GPUs haev a far shorter time period in which their processing power is doubled, namely every 6 months. Which is also driven by the gaming industry which requires a lot of performance out of computers aswell \ref{Meut2007}.
