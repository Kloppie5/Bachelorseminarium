...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{How to schedule and balance the workloads?} To schedule and balance the workloads, there are 3 major considerations: which tasks go or don't go in parallel? What is the order in which tasks will be executed? How can the load be distributed evenly across the machines?
