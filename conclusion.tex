...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item \textbf{How can these algorithms be partitioned and distributed across a wide variety of hardware?} To partition and distribute Machine Learning, there 5 sub-research questions that need to be answered:
		\begin{itemize}
			\item \textbf{What is the tradeoff between computation time VS communication VS accuracy?} TODO
			\item \textbf{How to schedule and balance the workloads?} To schedule and balance the workloads, there are 3 major considerations that need to be evaluated: which tasks go or don't go in parallel? What is the order in which tasks will be executed? How can the load be distributed evenly across the machines?
