...
\subparagraph{ML category: Goals}
.\\
...
\subparagraph{ML category: Types}
.\\
...
\subparagraph{ML category: Methods}
.\\
...
To schedule and balance the workload, we have to take 3 things into account:\cite{Xing16}\\
\begin{itemize}
...
The last consideration for the design of a Distributed Machine Learning is the way the computers within the cluster are organized. There are several network topologies used for Distributed Machine Learning clusters:
\begin{itemize}
