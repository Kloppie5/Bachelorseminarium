	...
	\item \textbf{Artificial neural networks (ANNs)}
		...
		\begin{itemize}
			...
			\item \textbf{Deep neural networks (DNNs)},
				are the opposite of \textbf{shallow neural networks}, and have many hidden layers. This may cause the network to work as a sort of a black-box, capable of simulating an arbitrary non-linear formula.
